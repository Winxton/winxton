...
It’s actually easier to come up with more ideas than less, because there’s less pressure to have a really good idea. Group of students judged on the quantity of photographs had better photos than those who were tasked on having one really good photo[^1]. Can’t think of 5 ideas? Think of 10. Newton studied alchemy, physics, and religion. That's probably enough pop psychology for today.

There are many projects that developers and hackers have spent so much time on but barely have any users. We don't sketch designs, write narratives and gather user feedback enough as engineers because it's much easier for us to just open our editor, and write code. Validating the market before writing code has been said over and over again, yet we still don't listen. It takes much less time to sketch out a design &mdash; no matter how simple &mdash; and show it to people to see whether they love it or just don't care.

## What about stealing?

I don't believe in secret projects. The advantage of a founder is how much time they thought about their project. I think execution matters more than the ideas, but a clearly thought out idea is worth its jewels.
